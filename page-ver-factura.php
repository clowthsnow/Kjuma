                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        ...
                                                                        if ($resultActivo->num_rows === 0) {
                                                                            ...
                                                                            echo "<td>"."<a href=\"page-ingresar-fact.php?barra=" . $row['KardexGBarraIdBarra'] . "\" target=\"\"><span class=\"task-cat green\">Facturita</span></a></td>";
                                                                            echo "<td>".$act['kardexFactura']."</td>";
                                                                        }
                                                                    }
                                                                    ?>
                                                                </tbody>
