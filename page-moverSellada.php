...
//    $provBD = $resultado->fetch_assoc();
    $buscar = "SELECT gbarrasellada.*, licor.licorNombre, kardexgbarra.KardexGBarraIdBarra, barra.barraNombre, discoteca.discotecaNombre, discoteca.discotecaId "
            . "FROM gbarrasellada "
            . "LEFT JOIN licor ON gbarrasellada.GBarraSelladaLicor=licor.licorId "
            . "LEFT JOIN kardexgbarra ON gbarrasellada.GBarraSelladaId=kardexgbarra.KardexGBarraSelladas "
            ...
            . "WHERE gbarrasellada.GBarraSelladaId='$origen' AND gbarrasellada.GBarraSelladaLicor='$licor'";
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Mover Selladas</h5>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Mover Selladas</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Mover Selladas</h4>
                                            <p class="caption">
                                                En este panel usted podra mover selladas de una barra hacia otra como sellada, barra o jarra.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Mover: <?php echo $resultado['licorNombre']; ?> <br> Stock: <?php echo $resultado['GBarraSelladaCantidad']; ?> <br> De: <?php echo $resultado['discotecaNombre'] . "-" . $resultado['barraNombre']; ?><br> A: </h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/moverSelladas.php" method="POST">
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="" type="text" class="validate" name="origen" required="" hidden="true" value="<?php echo $resultado['GBarraSelladaId']; ?>">
                                                                        <input id="" type="text" class="validate" name="licor" required="" hidden="true" value="<?php echo $resultado['GBarraSelladaLicor']; ?>">
                                                                        <input id="" type="text" class="validate" name="stockBD" required="" hidden="true" value="<?php echo $resultado['GBarraSelladaCantidad']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        ...
                                                                        <label class="" for="nombre">Unidades:</label>
                                                                    </div>
                                                                    <div class="col s12 m6 l6" id="contenedorTipo">
                                                                        <label >Como:</label>
                                                                        <select id="" class="browser-default" name="tipo" required="" >
                                                                            <option value="SK" selected="">Sellada</option>
                                                                            <option value="JK" >Jarra</option>
