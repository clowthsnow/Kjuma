...
//    }
    ...
    <html lang="es">
        ...
        <head>
            <title>Configurar Stock Jarras</title>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Configurar Stock Jarras</h5>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Configurar Stock Jarras</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Configurar Stock Jarras a <?php
                                                echo $provBD['barraNombre'];
                                                ;
                                                ?></h4>
                                            <p class="caption">
                                                En este panel usted podra configurar stock de jarras del kardex.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            ...
                                                            while ($row = $selladasResul->fetch_assoc()) {
                                                                echo "<tr>
                                                                    <td id=\"licor" . $cont . "\">" . $row['GBarraJarraLicor'] . "</td>
                                                                    <td>" . $row['licorNombre'] . "</td>
                                                                    <td>" . $row['categoriaLicorNombre'] . "</td>
                                                                    <td><div class=\"input-field col s6\"><input id=\"stock" . $cont . "\"placeholder=\"Stock\" id=\"cantidad\" type=\"number\" step=\"any\" class=\"validate\" value=\"" . $row['GBarraJarraCantidad'] . "\" min=\"0\">
                                                                             </div>" . "</td>
            ...
            <script>
                                                                        ...
                                                                        function guardar() {
                                                                            ...
                                                                            for (var i = 0; i < licores; i++) {
                                                                                ...
                                                                                $stock = $('#' + $tempcant);
                                                                                if ($stock.val() !== "") {
                                                                                    $url = "control/configurarKardexGJarra.php?licor=" + $licor.text() + "&stock=" + $stock.val() + "&codigo=" + codigo;
                                                                                    console.log($url);
                                                                                    $.ajax({
                                                                                        type: 'GET',
                                                                                        url: $url,
