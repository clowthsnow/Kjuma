...
//    echo $carta;
    ...
    $buscar = "SELECT cartasellada.*, licor.licorNombre FROM cartasellada "
            . "LEFT JOIN licor ON cartasellada.cartaSelladaLicor=licor.licorId"
            . " WHERE cartaSelladaId='$carta' AND cartaSelladaLicor='$licor'";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Carta: <?php echo $provBD['cartaSelladaId']; ?></h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/cambiarPrecioSellada.php" method="POST">
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="username" type="text" class="validate" name="id" required="" hidden="true" value="<?php echo $provBD['cartaSelladaId']; ?>">
                                                                        <input id="" type="text" class="validate" name="licor" required="" hidden="true" value="<?php echo $provBD['cartaSelladaLicor']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="precio"   value="<?php echo $provBD['cartaSelladaPrecio']; ?>">
