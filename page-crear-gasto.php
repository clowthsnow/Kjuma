...
if (!isset($_SESSION['usuario'])) {
    ...
    <html lang="es">
        ...
        <head>
            <title>Crear Gasto Economico</title>
                    ...
                    <section id="content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Registrar Gasto</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Gastos
                                            </li>
                                            <li class="active blue-text" >Registrar Gasto</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Registro de Gastos</h4>
                                            <p class="caption">
                                                En este panel usted podra registrar un nuevo gasto de dinero .
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Nuevo Gasto</h4>
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/crearGastoEconomico.php" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col s12 m6 l6">
                                                                        <label >Estado:</label>
                                                                        <select id="estado" class="browser-default" name="estado" required="">
                                                                            <option value="Cancelado" selected>Cancelado</option>
                                                                            <option value="Por Cancelar">Por Cancelar</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col s12 m6 l6" >
                                                                        <input id="cuotas" type="number" class="validate" name="cuotas" required="" value="0">
                        ...
                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Registro de gasto fallido, intente de nuevo.</p>
                            </div>
                        ...
                        <div id="modal2" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Registro de gasto exitoso.</p>
                            </div>
                            <div class="modal-footer">
                                <a href="page-crear-gasto.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                    </section>
                    <!-- END CONTENT -->
