                                ...
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            ...
                                            <p class="caption">
                                                En este panel usted podra ver todos las salidas de productos al deposito.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-row-grouping" class="responsive-table display " cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM salida WHERE salidaEstReg='A' ORDER BY salidaHora DESC";
                                                                    $resultado = $conexion->query($consultaUser) or die($conexion->error);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['salidaId'] . "</td>";
                                                                        $fecha = $row['salidaDia'] . "-" . $row['salidaMes'] . "-" . $row['salidaAnio'];
                                                                        $fecha2=$row['salidaFecha'];
                                                                        echo "<td>" . $fecha2 . "</td>"
                                                                                . "<td>".$row['salidaHora']."</td>";
                                                                        ...
                                                                        $consulta2 = "SELECT * FROM licor WHERE licorId='" . $row['salidaIdLicor'] . "'";
                                                                        $resultado1 = $conexion->query($consulta2) or die($conexion->error);
                                                                        while ($fila = $resultado1->fetch_assoc()) {
                                                                            echo "<td>" . $fila['licorNombre'] . "</td>";
                                                                        }
                                                                        
                                                                        echo"<td>" . $row['salidaCantidad'] . "</td>
                                                                        <td>" . $row['salidaIdUsuario'] . "</td>";
                                                                        if (in_array('5', $_SESSION['permisos'])) {
                                                                            echo "<td><a href=\"control/eliminarSalidaMercaderia.php?codigo=".$row['salidaId']."\" class=\"delete\"><span class=\"task-cat red\">Eliminar</span></a></td>";
                                                                        }
                                                                        echo "</tr>";
                                                                    }
                                                                    ?>
