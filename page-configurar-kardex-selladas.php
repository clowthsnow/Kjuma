...
//    }
    ...
    <html lang="es">
        ...
        <head>
            <title>Configurar Stock Selladas</title>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Configurar Stock Selladas</h5>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Configurar Stock Selladas</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Configurar Stock Selladas a <?php
                                                echo $provBD['barraNombre'];
                                                ;
                                                ?></h4>
                                            <p class="caption">
                                                En este panel usted podra configurar stock de selladas del kardex.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            ...
                                                            $selladasQuery = "SELECT gbarrasellada.*"
                                                                    ...
                                                                    . "WHERE gbarrasellada.GBarraSelladaId='$kardexSell'"
                                                            ...
                                                            while ($row = $selladasResul->fetch_assoc()) {
                                                                echo "<tr>
                                                                    <td id=\"licor" . $cont . "\">" . $row['GBarraSelladaLicor'] . "</td>
                                                                    <td>" . $row['licorNombre'] . "</td>
                                                                    <td>" . $row['categoriaLicorNombre'] . "</td>
                                                                    <td><div class=\"input-field col s6\"><input id=\"stock" . $cont . "\"placeholder=\"Stock\" id=\"cantidad\" type=\"number\" step=\"any\" class=\"validate\" value=\"".$row['GBarraSelladaCantidad'] ."\" min=\"0\">
                                                                             </div>" .  "</td>
            ...
            <script>
                                                                        ...
                                                                        function guardar() {
                                                                            ...
                                                                            for (var i = 0; i < licores; i++) {
                                                                                ...
                                                                                $stock = $('#' + $tempcant);
                                                                                if ($stock.val() !== "") {
                                                                                    $url = "control/configurarKardexGSellada.php?licor=" + $licor.text() + "&stock=" + $stock.val() + "&codigo=" + codigo;
                                                                                    console.log($url);
                                                                                    $.ajax({
                                                                                        type: 'GET',
                                                                                        url: $url,
