...
if (!isset($_SESSION['usuario'])) {
    ...
    $consultaUser = "SELECT * FROM gbarrasellada WHERE GBarraSelladaId='" . "S" . $codigo . "'";
    $resultadoLicor = $conexion->query($consultaUser) or die($conexion->error);

    $consultaCarta = "SELECT * FROM cartasellada WHERE cartaSelladaId='" . "SC" . $discoteca . "'";
    ...
    while ($fila = $resultadoLicor->fetch_assoc()) {
        $licCarta[] = $fila['GBarraSelladaLicor'];
    }
    $cont = 0;
    //$carta = "S" . $codigo;
    //echo $usuario;
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Añadir Selladas</h5>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Añadir Selladas</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Añadir Selladas a <?php echo $discoArr['barraNombre'];
                ; ?></h4>
                                            <p class="caption">
                                                En este panel usted podra añadir selladas al kardex.
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            ...
                                                            while ($row = $resultadoCarta->fetch_assoc()) {
                                                                if (!(in_array($row['cartaSelladaLicor'], $licCarta))) {
                                                                    echo "<tr>"
                                                                    . "<td id=\"licor" . $cont . "\">" . $row['cartaSelladaLicor'] . "</td>";
                                                                    $licorB = "SELECT * FROM licor WHERE licorId='" . $row['cartaSelladaLicor'] . "'";
                                                                        ...
                                                                        function guardar() {
                                                                            ...
                                                                            for (var i = 0; i < licores; i++) {
                                                                                ...
                                                                                if ($stock.val() !== "") {
                                                                                    ...
                                                                                    $.get("control/anadirKardexGSellada.php", {licor: $licor.text(), stock: $stock.val(), codigo: codigo}, function () {
