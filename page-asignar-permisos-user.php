                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Asignar Permisos</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Usuarios
                                            </li>
                                            <li class="grey-text lighten-4" >Crear Usuario</li>
                                            <li class="active blue-text">Asignar Permisos</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Asignacion de Permisos</h4>
                                            <p class="caption">
                                                En este panel usted podra asignar los permisos necesarios para el nuevo usuario creado.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Usuario: <?php echo $nombre . " " . $apellidos; ?></h4>
                                                        <div class="row">
                                                            <form id="permisos" class="col s12" action="control/asignarPermisos.php" method="POST">
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            if ($result->num_rows > 0) {
                                                                                ...
                                                                                while ($row = $result->fetch_assoc()) {
                                                                                    ?>
                                                                                    <input type="checkbox" id="<?php echo $row['sistemaID']; ?>" name="sistema[]" value="<?php echo $row['sistemaID']; ?>"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Guardar Permisos
