...
//    echo $carta;
    ...
    $buscar = "SELECT cartavaso.*, licor.licorNombre FROM cartavaso "
            . "LEFT JOIN licor ON cartavaso.cartaVasoLicor=licor.licorId"
            . " WHERE cartaVasoId='$carta' AND cartaVasoLicor='$licor'";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Carta: <?php echo $provBD['cartaVasoId']; ?></h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/cambiarPrecioVaso.php" method="POST">
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="username" type="text" class="validate" name="id" required="" hidden="true" value="<?php echo $provBD['cartaVasoId']; ?>">
                                                                        <input id="" type="text" class="validate" name="licor" required="" hidden="true" value="<?php echo $provBD['cartaVasoLicor']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="nombre" type="text" class="validate" name="precio"   value="<?php echo $provBD['cartaVasoPrecio']; ?>">
