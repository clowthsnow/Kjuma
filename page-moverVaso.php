...
//    $provBD = $resultado->fetch_assoc();
    $buscar = "SELECT gbarravaso.*, licor.licorNombre, kardexgbarra.KardexGBarraIdBarra, barra.barraNombre, discoteca.discotecaNombre, discoteca.discotecaId "
            . "FROM gbarravaso "
            . "LEFT JOIN licor ON gbarravaso.GBarraVasoLicor=licor.licorId "
            . "LEFT JOIN kardexgbarra ON gbarravaso.GBarraVasoId=kardexgbarra.KardexGBarraVaso "
            ...
            . "WHERE gbarravaso.GBarraVasoId='$origen' AND gbarravaso.GBarraVasoLicor='$licor'";
                ...
                <div class="wrapper">
                    ...
                    <section id="content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l2 s12 m12 l8">
                                                    <div class="card-panel">
                                                        <h4 class="header2">Mover: <?php echo $resultado['licorNombre']; ?> <br> Stock: <?php echo $resultado['GBarraVasoCantidad']; ?> <br> De: <?php echo $resultado['discotecaNombre'] . "-" . $resultado['barraNombre']; ?><br> A: </h4>
                                                        <div class="row">
                                                            <form id="configurar" class="col s12" action="control/moverVasos.php" method="POST">
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="" type="text" class="validate" name="origen" required="" hidden="true" value="<?php echo $resultado['GBarraVasoId']; ?>">
                                                                        <input id="" type="text" class="validate" name="licor" required="" hidden="true" value="<?php echo $resultado['GBarraVasoLicor']; ?>">
                                                                        <input id="" type="text" class="validate" name="stockBD" required="" hidden="true" value="<?php echo $resultado['GBarraVasoCantidad']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        ...
                                                                        <label class="" for="nombre">Vasos:</label>
                                                                    </div>
                                                                    <div class="col s12 m6 l6" id="contenedorTipo">
                                                                        <label >Como:</label>
                                                                        <select id="" class="browser-default" name="tipo" required="" >
                                                                            ...
                                                                            <option value="VK" selected="" >Vaso</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <br>
                        ...
                        <div id="modal3" class="modal">
                            <div class="modal-content">
                                <h4 class="red-text">ERROR!!!</h4>
                                <p>Error al transformar de vasos a jarras/selladas, intentelo de nuevo.</p>
                            </div>
                            <div class="modal-footer">
                                <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
