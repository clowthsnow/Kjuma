                    ...
                    <section id="content">
                        ...
                        <div id="modal1" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Discoteca no creada correctamente.</p>
                            </div>
                        ...
                        <div id="modal2" class="modal">
                            <div class="modal-content">
                                ...
                                <p>Discoteca creada correctamente.</p>
                            </div>
                            <div class="modal-footer">
                                <a href="page-crear-discoteca.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                            </div>
                        </div>
                    </section>
                    <!-- END CONTENT -->
