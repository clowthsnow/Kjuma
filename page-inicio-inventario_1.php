                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td><div class=\"input-field col s6\"><input id=\"stock".$cont."\"placeholder=\"Inicio\" id=\"cantidad\" type=\"number\" step=\"any\" class=\"validate\" value=\"" . $row['inventarioGeneralDetalleRango'] . "\">
                                                                             </div></td>
                                                                            </tr>";
                                                                $cont++;
                                                            }
            ...
            <script>
                ...
                function guardar(){
                    ...
                    for(var i=0;i<licores;i++){
                        ...
                        $licor=$('#'+$templicor);
                        $stock=$('#'+$tempcant);
                        $.get( "control/guardarInventario_1.php", { licor:$licor.text() , cantidad: $stock.val() }, function (){
