                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Consumo</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Gestion de Deposito
                                            </li>
                                            <li class="active blue-text" >Consumo</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Consumo</h4>
                                            <p class="caption">
                                                En este panel usted podra realizar una salida de deposito para los consumos.
                                            </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col offset-l1 s12 m12 l10">
                                                    <div class="card-panel">
                                                        ...
                                                        <div class="row">
                                                            <form id="create" class="col s12" action="control/crearConsumoMercaderia.php" method="POST">
                                                                ...
                                                                <?php // while ($row = $result->fetch_assoc()) { ?>
                                                                                                                                                <option value="<?php echo $row['discotecaId']; ?>" selected><?php echo $row['discotecaNombre']; ?></option>
                                                                <?php // }
                                                                ?>
                                                                ...
                                                                <?php // while ($row = $resultProv->fetch_assoc()) { ?>
                                                                                                                                                <option value="<?php echo $row['barraId']; ?>" ><?php echo $row['barraNombre']; ?></option>
                                                                <?php // }
                                                                ?>
                                                                                                                                        </select>
                                                                                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col s12 m12 l12">
                                                                        <input id="info" type="text" class="validate" name="info" required="" >
                                                                        <label for="info" id="detalletag">Detalle:</label>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <br>
...
//                                                                . " ORDER BY categorialicor.categoriaLicorNombre"
            ...
            <script>
                                                                        ...
                                                                        function limpiar() {
                                                                            ...
                                                                            $('#codigo').focus();
                                                                            $('#info').val("");
                                                                            $('#detalletag').removeAttr('class', 'active');
                                                                        }
                                                                        function verModal() {
                                                                            $('#modal2').openModal();
                                                                        }
