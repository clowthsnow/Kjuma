...
$fecha = $_GET['fecha'];
$medida = $_GET['medida'];
$codigoLicor = $_GET['codigo'];
$cantidadProd = $_GET['cantidad'];
$discoteca = $_GET['discotecas'];
$barra = $_GET['barra'];
$uso = $_GET['uso'];
$codigoSJV;
...
//$nombreLic = $_GET['licor'];
$stockLic=0;
$buscarStock = "SELECT * FROM inventariogeneraldetalle WHERE inventarioGeneralDetalleLicor='$codigoLicor'";
$result = $conexion->query($buscarStock);
if ($row = $result->fetch_assoc()) {
//    $discoNombre = $row['discotecaNombre'];
    $stockLic=$row['inventarioGeneralDetalleCantidad'];
}
//echo $nombreLic;
//echo $stockLic;
if (!isset($usuario) || !isset($fecha) || !isset($medida) || !isset($discoteca) || !isset($barra) || !isset($codigoLicor) || !isset($cantidadProd) || !isset($hora)) {
