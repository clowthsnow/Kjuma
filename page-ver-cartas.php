                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Cartas</h5>
                                        <ol class="breadcrumb">
                                            <li class=" grey-text lighten-4">Kardex
                                            </li>
                                            <li class="active blue-text">Cartas</li>
                                        </ol>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            <h4 class="header">Cartas</h4>
                                            <p class="caption">
                                                En este panel usted podra ver todas las cartas almacenadas en el sistema por cada discoteca y poder gestionarlas.
                                            </p>
                                            <div class="divider"></div>
                                            <div class="container">
                                                <!--DataTables example-->
                                                <div id="table-datatables">
                                                    <h4 class="header">Carta:</h4>
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            <table id="data-table-simple" class="responsive-table display " cellspacing="0">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $consultaUser = "SELECT * FROM carta WHERE cartaEstReg='A'";
                                                                    $resultado = $conexion->query($consultaUser);
                                                                    while ($row = $resultado->fetch_assoc()) {
                                                                        echo "<tr>
                                                                        <td>" . $row['cartaId'] . "</td>";
                                                                        $consulta = "SELECT * FROM discoteca WHERE discotecaId='" . $row['cartaDiscoteca'] . "'";
                                                                        ...
                                                                        echo "<td><a href=\"page-configurar-carta.php?carta=" . $row['cartaId'] . "\"><span class=\"task-cat cyan\">Configurar</span></a></td>";
                                                                    }
                                                                    ?>
                                                                </tbody>
                                                            </table>
