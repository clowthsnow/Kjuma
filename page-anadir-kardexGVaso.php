...
if (!isset($_SESSION['usuario'])) {
    ...
    $consultaUser = "SELECT * FROM gbarravaso WHERE GBarraVasoId='" . "V" . $codigo . "'";
    $resultadoLicor = $conexion->query($consultaUser) or die($conexion->error);

    $consultaCarta = "SELECT * FROM cartavaso WHERE cartaVasoId='" . "VC" . $discoteca . "'";
    ...
    <html lang="es">
        ...
        <body>
            ...
            <div id="main">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h5 class="breadcrumbs-title">Añadir Vasos</h5>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active blue-text">Añadir Vasos</li>
                                        </ol>
                ...
                ; ?></h4>
                                            <p class="caption">
                                                En este panel usted añadir jarras al kardex. Nota: Ingrese  cantidad de vasos no de selladas (1 sellada= 12 vasos).
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12">
                                                            ...
                                                            while ($row = $resultadoCarta->fetch_assoc()) {
                                                                if (!(in_array($row['cartaVasoLicor'], $licCarta))) {
                                                                    echo "<tr>"
                                                                    . "<td id=\"licor" . $cont . "\">" . $row['cartaVasoLicor'] . "</td>";
                                                                    $licorB = "SELECT * FROM licor WHERE licorId='" . $row['cartaVasoLicor'] . "'";
                                                                        ...
                                                                        function guardar() {
                                                                            ...
                                                                            for (var i = 0; i < licores; i++) {
                                                                                ...
                                                                                if ($stock.val() !== "") {
                                                                                    ...
                                                                                    $.get("control/anadirKardexGVaso.php", {licor: $licor.text(), stock: $stock.val(), codigo: codigo}, function () {
