...
if (!isset($_SESSION['usuario'])) {
    ...
    $consultaCarta = "SELECT * FROM cartajarra WHERE cartaJarraId='" . "J" . $codigoDisco . "'";
    ...
    <html lang="es">
        ...
        <head>
            <title>Añadir precio Jarras</title>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="section">
                                        <div id="roboto">
                                            ...
                                            <p class="caption">
                                                En este panel usted añadir el precio por jarra de los productos que aun no cuentan con un precio.
                                            </p>
                                                                        ...
                                                                        function guardar() {
                                                                            ...
                                                                            for (var i = 0; i < licores; i++) {
                                                                                ...
                                                                                if ($stock.val() !== "") {
                                                                                    ...
                                                                                    $.get("control/anadirCartaJarra.php", {licor: $licor.text(), precio: $stock.val(), discoteca: disco}, function () {
